...
function RandomColor() {
  ...
  function colorutility(length) {
    return Math.floor(Math.random() * length); // random generates number b/n 0-1 * lenght = b/n 0 to length-1 & floor rounds it down to nearest whole number
  }
  ...
  }, [colortype]); // Reacts when colortype changes
